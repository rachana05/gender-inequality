...
var funLib = ["$%$%", "####", "%Sorry not-so-kid friendly word present here%", "!@#$", "&^%&^%",
            "Blah-Blah", ":( :( :(", "##Bad content##", "✧・ﾟ:* ", " (ﾉ◕ヮ◕)ﾉ*:・ﾟ✧",
            "!!!Curse detected!!!", "#%$d$%#", "Meh...","<3", "( ͡° ͜ʖ ͡°)", "Dot..Dot..Dot",
            "Error 404040", "(*_*)", "Can't display FML detected me!"
            ];
...
for (var i = 0; i < elements.length; i++) {
    ...
    for (var j = 0; j < element.childNodes.length; j++) {
        ...
        if (node.nodeType === 3) {
            ...
            "Live Laugh Love", ":( :( :(", "Juicy Couture", "~*~*~Ghéy~*~*~", "✧・ﾟ:* ", " (ﾉ◕ヮ◕)",
